...
<body>
	...
	<div class="container">
		...
		<!-- Menu Section -->
		<div class="menu">
			<a href="${pageContext.request.contextPath}/news">Thêm tin tức
				mới</a> | <a href="${pageContext.request.contextPath}/list">Danh
				sách tin tức</a>
		</div>
						...
						<td>
							<form action="${pageContext.request.contextPath}/managelist"
								...
								<input type="hidden" name="action" value="remove"> <input
									type="hidden" name="maTT" value="${item.maTT}"> <input
